    ...
    <main className="relative min-h-screen w-full flex flex-col items-center justify-center p-4 overflow-hidden bg-[#bcd9f8] select-none">
      ...
      <div className="relative z-10 w-full max-w-[440px] flex flex-col items-center">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="w-full bg-white/95 backdrop-blur-md rounded-[32px] shadow-[0_20px_60px_rgba(50,80,180,0.18)] px-8 py-9 sm:px-11 border border-white/70"
        >
          {/* Headings */}
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <motion.div
              ...
              className="flex items-center gap-2 pt-1 select-none"
            >
              <input
                type="checkbox"
                id="terms"
              ...
              <label
                htmlFor="terms"
                className="text-[11px] text-gray-500 font-medium cursor-pointer"
              >
                I agree to the{" "}
            ...
            <motion.div variants={itemVariants} className="pt-2">
              <motion.button
                ...
                type="submit"
                className="w-full py-2.5 px-4 bg-[#4f6bf2] hover:bg-[#435ee3] text-white text-xs font-semibold rounded-xl shadow-md shadow-indigo-200/50 transition-colors cursor-pointer"
              >
                Sign up
              </motion.button>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <motion.button
                ...
                whileTap={{ scale: 0.985 }}
                type="button"
                className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 bg-white text-gray-700 text-xs font-medium border border-gray-200 rounded-xl transition-colors shadow-sm cursor-pointer"
              >
          ...
          <motion.p
            variants={itemVariants}
            className="text-center text-[11px] text-gray-500 mt-6"
          >
